...
namespace DAOs.Migrations
{
    ...
    [Migration("20240607105353_Add-Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjects.Class", b =>
                {
                    ...
                    b.HasKey("ClassId")
                        .HasName("PK__Class__CB1927A075246046");
            ...
            modelBuilder.Entity("BusinessObjects.Complaint", b =>
                {
                    ...
                    b.HasKey("ComplaintId")
                        .HasName("PK__Complain__740D89AF8A390664");
            ...
            modelBuilder.Entity("BusinessObjects.Conversation", b =>
                {
                    ...
                    b.HasKey("ConversationId")
                        .HasName("PK__Conversa__C050D897F2B13050");
            ...
            modelBuilder.Entity("BusinessObjects.Feedback", b =>
                {
                    ...
                    b.HasKey("FeedbackId")
                        .HasName("PK__Feedback__6A4BEDF6A430A378");
            ...
            modelBuilder.Entity("BusinessObjects.FindTutorForm", b =>
                {
                    ...
                    b.HasKey("FormId")
                        .HasName("PK__FindTuto__FB05B7BD0A42AC0E");
            ...
            modelBuilder.Entity("BusinessObjects.Grade", b =>
                {
                    ...
                    b.HasKey("GradeId")
                        .HasName("PK__Grade__54F87A3760C042FB");
            ...
            modelBuilder.Entity("BusinessObjects.Message", b =>
                {
                    ...
                    b.HasKey("MessageId")
                        .HasName("PK__Message__C87C037C0A5AD8AF");
            ...
            modelBuilder.Entity("BusinessObjects.Notification", b =>
                {
                    ...
                    b.HasKey("NotificationId")
                        .HasName("PK__Notifica__20CF2E326158476D");
            ...
            modelBuilder.Entity("BusinessObjects.Role", b =>
                {
                    ...
                    b.HasKey("RoleId")
                        .HasName("PK__Role__8AFACE3A7E17C289");
            ...
            modelBuilder.Entity("BusinessObjects.Student", b =>
                {
                    ...
                    b.HasKey("StudentId")
                        .HasName("PK__Student__32C52A794047BE7F");
            ...
            modelBuilder.Entity("BusinessObjects.Subject", b =>
                {
                    ...
                    b.HasKey("SubjectId")
                        .HasName("PK__Subject__AC1BA388110ED676");
            ...
            modelBuilder.Entity("BusinessObjects.SubjectGroup", b =>
                {
                    ...
                    b.HasKey("SubjectGroupId")
                        .HasName("PK__SubjectG__2F88B016CAEB0678");
            ...
            modelBuilder.Entity("BusinessObjects.Transaction", b =>
                {
                    ...
                    b.HasKey("TransactionId")
                        .HasName("PK__Transact__55433A4BB44B128F");
            ...
            modelBuilder.Entity("BusinessObjects.Tutor", b =>
                {
                    ...
                    b.HasKey("TutorId")
                        .HasName("PK__Tutor__77C70FC2C3029336");
            ...
            modelBuilder.Entity("BusinessObjects.TutorAd", b =>
                {
                    ...
                    b.HasKey("AdsId")
                        .HasName("PK__Tutor_Ad__46AAC65A76DC4050");
            ...
            modelBuilder.Entity("BusinessObjects.Wallet", b =>
                {
                    ...
                    b.HasKey("WalletId")
                        .HasName("PK__Wallet__84D4F92E3B79BB2C");
            ...
            modelBuilder.Entity("ConversationAccount", b =>
                {
                    b.Property<string>("ConversationId")
                        .HasMaxLength(5)
                        .IsUnicode(false)
                    ...
                    b.HasKey("ConversationId", "AccountId")
                        .HasName("PK__Conversa__B31902CFC2376C8C");
            ...
            modelBuilder.Entity("SubjectTutor", b =>
                {
                    ...
                    b.HasKey("SubjectId", "TutorId")
                        .HasName("PK__Subject___9B67D3744EE0D81F");
            ...
            modelBuilder.Entity("ConversationAccount", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.Conversation", null)
                        .WithMany()
                        .HasForeignKey("ConversationId")
                        .IsRequired()
            ...
            modelBuilder.Entity("SubjectTutor", b =>
                {
                    b.HasOne("BusinessObjects.Subject", null)
                        .WithMany()
                        .HasForeignKey("SubjectId")
                        .IsRequired()
                        .HasConstraintName("FKSubject_Tu675031");

                    b.HasOne("BusinessObjects.Tutor", null)
                        .WithMany()
                        .HasForeignKey("TutorId")
                        .IsRequired()
