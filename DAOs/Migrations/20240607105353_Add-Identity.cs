    ...
    public partial class AddIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Conversa__C050D897F2B13050", x => x.ConversationID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Grade__54F87A3760C042FB", x => x.GradeID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Role__8AFACE3A7E17C289", x => x.RoleID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SubjectG__2F88B016CAEB0678", x => x.SubjectGroupID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subject__AC1BA388110ED676", x => x.SubjectID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Conversa__B31902CFC2376C8C", x => new { x.ConversationID, x.AccountID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Message__C87C037C0A5AD8AF", x => x.MessageID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notifica__20CF2E326158476D", x => x.NotificationID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Student__32C52A794047BE7F", x => x.StudentID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Tutor__77C70FC2C3029336", x => x.TutorID);
                    table.ForeignKey(
                        name: "FKTutor387597",
                        column: x => x.AccountID,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Wallet__84D4F92E3B79BB2C", x => x.WalletID);
                    table.ForeignKey(
                        name: "FKWallet115696",
                        column: x => x.AccountID,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__FindTuto__FB05B7BD0A42AC0E", x => x.FormID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Class__CB1927A075246046", x => x.ClassID);
                    table.ForeignKey(
                        name: "FKClass105998",
                        column: x => x.SubjectID,
                        principalTable: "Subject",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Complain__740D89AF8A390664", x => x.ComplaintID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subject___9B67D3744EE0D81F", x => new { x.SubjectID, x.TutorID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Tutor_Ad__46AAC65A76DC4050", x => x.AdsID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Transact__55433A4BB44B128F", x => x.TransactionID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Feedback__6A4BEDF6A430A378", x => x.FeedbackID);
                    table.ForeignKey(
